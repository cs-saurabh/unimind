...
This repository includes compiled knowledge graphs generated by the `/understand` skill. To explore the codebase architecture, relationships, and structure, you'll need the Understand-Anything plugin:
...
**Generate or update the knowledge graph:**
```bash
/understand
```

This creates `.understand-anything/knowledge-graph.json` which provides:
- File structure and component relationships
- Architectural layers and dependencies
- Code entity index (functions, classes, modules)
- Guided tours through key system flows
...
Ask questions like:
- "What is unimind?"
- "How does the write pipeline work?"
